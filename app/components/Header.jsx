      ...
      <header className="inset-x-0 top-0 z-50 sticky opacity-90 bg-white">
        <nav className="flex items-center justify-between px-8 py-5 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <img src='/LinkedIn.png' width={30} height={30} className="me-2" /> <img src='/Facebook.png' width={30} height={30} /></span><span aria-hidden="true"></span>
            </a>
          </div>
        </nav>
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          <div className="fixed inset-0 z-50" />
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-slate-200 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
