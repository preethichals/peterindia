...
<footer className=" bg-neutral-900 container mx-auto max-w-full shadow dark:bg-gray-900">
  <div className="w-full max-w-screen-xl mx-auto p-4 text-slate-50">
    <div className="sm:flex sm:items-center sm:justify-between">
         <span className="block text-sm  sm:text-center dark:text-gray-400"><a href="mailto:preethi.lyn@gmail.com" className="hover:underline"> Created by Preethi-- © 2024 </a><a href="mailto:peterindia@gmail.com" className="hover:underline">PeterIndia™</a>. All Rights Reserved.</span>
